...
public class StudentService {
	...
	public void removeStudent(Long studentId) {
		...
		if (!student.isPresent()) {
			throw new EducationIllegalStateException("Failed to remove Student. Invalid StudentId :: " + studentId);
		}
	...
	public void registerCourse(Long studentId, Set<Course> courses) {
		...
		if (!studentOptional.isPresent()) {
			throw new EducationIllegalStateException("Failed to register course. Invalid CourseId :: " + studentId);
		}
	...
	public Set<Student> getStudentsByCourseName(String courseName) {
		...
		if (!course.isPresent()) {
			throw new EducationIllegalStateException("Failed to get Students. Invalid courseName :: " + courseName);
		}
